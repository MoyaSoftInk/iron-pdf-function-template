...
namespace IronPdfExample.Converter
{
    /// <summary>
    /// Utilizada para permitir la deserialización de objetos JSON a Diccionario
    /// </summary>
    public class DictionaryConverter : JsonConverter
    {
        ...
        private void WriteArray(JsonWriter writer, object value)
        {
            ...
            IEnumerable<object>? array = value as IEnumerable<object>;
            foreach (IEnumerable<object> o in array!)
            {
